...
import { FileKey, RefreshCw, AlertCircle } from "lucide-react";
    ...
    <>
      <Header>
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-semibold">Issue Credentials</h2>
        </div>
            ...
            credentials.map((cred) => {
              ...
              return (
                <Card 
                  ...
                  onClick={() => router.push(`/issue/${cred.supported_cred_id}`)}
                  style={{
